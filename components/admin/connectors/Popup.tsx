...
// Export the PopupSpec type for use in other components
export type PopupSpec = BasePopupSpec
// Export the PopupType type for use in other components
...
// Add the usePopup hook
export function usePopup() {
  const [popup, setPopup] = useState<ExtendedPopupSpec | null>(null)
  ...
  return {
    popup: popup ? <Popup popup={popup} onClose={clearPopup} /> : null,
    setPopup,
    clearPopup
  }
}
