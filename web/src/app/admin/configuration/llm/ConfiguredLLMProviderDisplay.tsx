import { PopupSpec, usePopup, Popup } from "@/components/admin/connectors/Popup";
...
function PopupDisplay({ popup }: { popup: (PopupSpec & { onClose: () => void }) | null }) {
      ...
      <div className="border border-border p-3 dark:bg-neutral-800 dark:border-neutral-700 rounded w-96 flex shadow-md">
        ...
        {existingLlmProvider && (
          <div className="my-auto ml-3">
            {existingLlmProvider.is_default_provider ? (
              <Badge variant="default" className="bg-blue-500 text-white">Default</Badge>
            ) : (
        ...
        <div className="ml-auto">
          <Button
            ...
            className={existingLlmProvider ? "border-green-600 text-green-600 hover:bg-green-50" : "bg-blue-500 text-white hover:bg-blue-600"}
